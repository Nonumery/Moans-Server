...
@router.get("/", response_model=List[User], response_model_exclude=["hash_password", "update_token"], include_in_schema=False)
...
@router.get("/registration/{email}/{password}/{token}", response_model=User, response_model_exclude=["hash_password", "update_token"], include_in_schema=False)
